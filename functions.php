...
function starkers_setup() {
	...
	//load SlickNav scripts and styles
	wp_enqueue_style( 'slicknav-styles', get_template_directory_uri() . '/slicknav/slicknav.min.css' );
	wp_enqueue_script( 'slicknav-js', get_template_directory_uri() . '/slicknav/jquery.slicknav.min.js', array('jquery'), true );
}
endif;
